-- Migration: Add single-claim chore system and update dog feeding emojis
-- Run this in Supabase SQL Editor

-- Step 1: Update dog feeding chore emojis
...
-- Step 2: Add single_claim column to chores table
...
-- Step 3: Mark single-claim chores (only one player can do these per cooldown)
